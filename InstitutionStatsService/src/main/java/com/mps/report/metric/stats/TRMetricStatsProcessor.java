...
public class TRMetricStatsProcessor implements Serializable {
	...
	private static Document getPreviousDocWithStats() {
		...
		try {
			...
			append(Constants.JOURNAL_ID, previousDoc.get(Constants.JOURNAL_ID).toString()).
	...
	public static void setLastDocument(Document lastDocument) {
		TRMetricStatsProcessor.lastDocument = lastDocument;
	}
